...
public class PhotoCaptureHandler : MonoBehaviour
{
    ...
    void TakePicture()
    {
        ...
        string filePath = System.IO.Path.Combine("C:/Data/myholo/Pictures/Camera Roll", filename);
        //string filePath = System.IO.Path.Combine("C:/Users/kemal/Videos/Captures", filename);
